...
class DetailsUnApprovalOrder extends StatefulWidget {
  const DetailsUnApprovalOrder({Key key}) : super(key: key);

  @override
  State<DetailsUnApprovalOrder> createState() => _DetailsUnApprovalOrderState();
}

class _DetailsUnApprovalOrderState extends State<DetailsUnApprovalOrder> {
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Padding(
                    padding: const EdgeInsets.only(left: defaultPadding),
                    child: const Flexible(child: Text("10M/16")),
                  ),
                ),
              ],
            ),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Padding(
                    padding: const EdgeInsets.only(left: defaultPadding),
                    child: const Flexible(child: Text("10M00016.jpg")),
                  ),
                ),
              ],
            ),
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: const Text("สมเด็จฯ กรมพระยาดำรงราชานุภาพ"),
                  ),
                ],
              ),
            ),
