...
import 'details_unapproval_order.dart';

class EmployeeUnApprovedOrder extends StatefulWidget {
  const EmployeeUnApprovedOrder({Key key}) : super(key: key);

  @override
  State<EmployeeUnApprovedOrder> createState() =>
      _EmployeeUnApprovedOrderState();
}

class _EmployeeUnApprovedOrderState extends State<EmployeeUnApprovedOrder> {
  ...
  Widget _unstatusSectionCard() => Container(
        padding: const EdgeInsets.symmetric(horizontal: defaultPadding / 1),
        alignment: FractionalOffset.topCenter,
        child: Row(
          mainAxisAlignment: MainAxisAlignment.start,
          children: <Widget>[
            Padding(
              padding: const EdgeInsets.only(left: defaultPadding),
              child: const Text("เหตุผลในการพิจารณาไม่อนุมัติ :"),
            ),
            Flexible(
              child: Padding(
                padding: const EdgeInsets.only(left: defaultPadding),
                child: const Text("xxxxxxxxxxxxxxxxxx",
  ...
  Widget _dayforapproveSectionCard() => Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Padding(
              padding: const EdgeInsets.only(left: defaultPadding),
              child: const Text("วันที่พิจารณาไม่อนุมัติ :"),
            ),
            Padding(
              padding: const EdgeInsets.only(left: defaultPadding),
              child: const Text(
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const DetailsUnApprovalOrder(),
                ),
              );
            },
            child: Padding(
