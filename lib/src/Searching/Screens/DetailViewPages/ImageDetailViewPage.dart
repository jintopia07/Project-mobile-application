...
import 'package:nat/src/Searching/Screens/ListViewPages/NearestImageListViewPage.dart';
...
class ImageDetailViewPage extends StatefulWidget {
  final DigitalFile digitalFile;
  const ImageDetailViewPage({Key key, this.digitalFile}) : super(key: key);

  @override
  ImageDetailViewPageState createState() => ImageDetailViewPageState();
}

class ImageDetailViewPageState extends State<ImageDetailViewPage> {
  ...
  void initState() {
    ...
    initialize().then((value) => {
          initializeImages().then((value) => {showInfoImages()})
        });
  }

  showInfoImages() async {
    setState(() => {
          _body = Scaffold(
            appBar: AppBar(
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                      height: 800,
                      child: NearestImageListviewPage(
                        nearestDigitalFiles,
                      ),
                    )
                  ],
