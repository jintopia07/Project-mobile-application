...
class NearestImageListviewPage extends StatefulWidget {
  List<DigitalFile> nearestDigitalFiles;
  NearestImageListviewPage(this.nearestDigitalFiles) {
    initialize();
  }
  ...
  @override
  NearestImageListViewPageState createState() =>
      NearestImageListViewPageState();
}

class NearestImageListViewPageState extends State<NearestImageListviewPage> {
  List<DigitalFile> nearestDigitalFiles;
