...
class NearestSoundListViewPage extends StatefulWidget {
  List<DigitalFile> nearestDigitalFiles;
  NearestSoundListViewPage(this.nearestDigitalFiles) {
    initialize();
  }
  ...
  @override
  NearestSoundListViewPageState createState() =>
      NearestSoundListViewPageState();
}

class NearestSoundListViewPageState extends State<NearestSoundListViewPage> {
  List<DigitalFile> nearestDigitalFiles;
