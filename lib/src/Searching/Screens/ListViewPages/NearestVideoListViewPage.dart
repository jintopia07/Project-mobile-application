...
class NearestVideoListViewPage extends StatefulWidget {
  List<DigitalFile> nearestDigitalFiles;
  NearestVideoListViewPage(this.nearestDigitalFiles) {
    initialize();
  }
  ...
  @override
  NearestVideoListViewPageState createState() =>
      NearestVideoListViewPageState();
}

class NearestVideoListViewPageState extends State<NearestVideoListViewPage> {
  List<DigitalFile> nearestDigitalFiles;
